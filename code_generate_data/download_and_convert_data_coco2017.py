...
from datasets import download_and_convert_visualwakewords_coco2017
...
tf.flags.DEFINE_string(
    'foreground_class_of_interest', 'motorcycle',
...
def main(_):
  ...
  if FLAGS.dataset_name == 'flowers':
    ...
    download_and_convert_visualwakewords_coco2017.run(
