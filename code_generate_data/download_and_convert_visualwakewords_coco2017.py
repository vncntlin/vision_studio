...
import sys
sys.path.append(r"C:/Users/user/Desktop/project_new/TensorFlowLite/contest/models/research/slim")
from datasets import download_and_convert_visualwakewords_lib_coco2017
...
def run(dataset_dir, small_object_area_threshold, foreground_class_of_interest):
  ...
  # download_and_convert_visualwakewords_lib_coco2017.download_coco_dataset(coco_dir)
  ...
  visualwakewords_annotations_train = os.path.join(
      dataset_dir, 'instances_visualwakewords_train2017.json')
  visualwakewords_annotations_val = os.path.join(
      dataset_dir, 'instances_visualwakewords_val2017.json')
  ...
  download_and_convert_visualwakewords_lib_coco2017.create_labels_file(
  ...
  download_and_convert_visualwakewords_lib_coco2017.create_visual_wakeword_annotations(
  ...
  download_and_convert_visualwakewords_lib_coco2017.create_tf_record_for_visualwakewords_dataset(
  ...
  download_and_convert_visualwakewords_lib_coco2017.create_tf_record_for_visualwakewords_dataset(
      ...
      val_output_path,
      num_shards=10)'''
  # DUES 3. Use COCO annotations to create VisualWakeWords annotations
  new_data_dir = os.path.join(dataset_dir, 'dues_data')
  new_data_dir_train = os.path.join(new_data_dir, 'train')
  new_data_dir_train_noobj = os.path.join(new_data_dir_train, 'no_object')
  new_data_dir_train_obj = os.path.join(new_data_dir_train, 'object')
  new_data_dir_val = os.path.join(new_data_dir, 'val')
  new_data_dir_val_noobj = os.path.join(new_data_dir_val, 'no_object')
  new_data_dir_val_obj = os.path.join(new_data_dir_val, 'object')
  try:
    os.mkdir(new_data_dir)
    os.mkdir(new_data_dir_train)
    os.mkdir(new_data_dir_train_noobj)
    os.mkdir(new_data_dir_train_obj)
    os.mkdir(new_data_dir_val)
    os.mkdir(new_data_dir_val_noobj)
    os.mkdir(new_data_dir_val_obj)
  except:
    print('error')
  # tf.logging.info('Dues: Creating train VisualWakeWords annotations...')
  # download_and_convert_visualwakewords_lib_coco2017.dues_create_visual_wakeword_annotations(
  #     train_annotations_file, visualwakewords_annotations_train,
  #     small_object_area_threshold, foreground_class_of_interest,
  #     train_image_dir, new_data_dir_train, 'train')
  # tf.logging.info('Dues: Creating validation VisualWakeWords annotations...')
  # download_and_convert_visualwakewords_lib_coco2017.dues_create_visual_wakeword_annotations(
  #     val_annotations_file, visualwakewords_annotations_val,
  #     small_object_area_threshold, foreground_class_of_interest,
  #     val_image_dir, new_data_dir_val, 'val')
  foreground_class_of_interest_1 = 'bicycle'
  foreground_class_of_interest_2 = 'motorcycle'
  tf.logging.info('Dues: Creating train VisualWakeWords annotations...')
  download_and_convert_visualwakewords_lib_coco2017.dues_2class_create_visual_wakeword_annotations(
      train_annotations_file, visualwakewords_annotations_train,
      small_object_area_threshold,
      foreground_class_of_interest_1, foreground_class_of_interest_2,
      train_image_dir, new_data_dir_train, 'train')
  tf.logging.info('Dues: Creating validation VisualWakeWords annotations...')
  download_and_convert_visualwakewords_lib_coco2017.dues_2class_create_visual_wakeword_annotations(
      val_annotations_file, visualwakewords_annotations_val,
